...
export interface DataTableYatuItem {
  name: string;
  id: number;
  amount: number;
}
...
const EXAMPLE_DATA: DataTableYatuItem[] = [
...
/**
 * Data source for the DataTableYatu view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class DataTableYatuDataSource extends DataSource<DataTableYatuItem> {
  data: DataTableYatuItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<DataTableYatuItem[]> {
   ...
   */
  private getPagedData(data: DataTableYatuItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: DataTableYatuItem[]) {
